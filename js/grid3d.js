...
;( function( window ) {
	...
	grid3D.prototype._init = function() {
		...
		// grid element
		this.grid = this.gridWrap.querySelector( 'div.gridLightbox' );
		// main grid items
		...
		// content
		this.contentEl = this.el.querySelector( 'div.worksContent' );
		// content items
	...
	grid3D.prototype._hideContent = function() {
		var self = this,
			contentItem = this.el.querySelector( 'div.worksContent > .show' ),
